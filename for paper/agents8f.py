from game8f import board_size, play_round, num_food, get_desired_space_from_action
import numpy as np
import random
...
class CooperativeAI:
    def __init__(self, position):
        ...
        self.savepath = "dqn8f_f256k5_sgdn_lr00001_rewardboth10_batch8"
        ...
        print("8dqn, sgdn, 0.00001, 256k5, 128 hidden, batch 1, rewardboth10")
