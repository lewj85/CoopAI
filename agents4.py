...
class CooperativeAI:
    def __init__(self, position):
        ...
        self.savepath = "dqn8_f64k5_allyinput_nadam_lr002"
        ...
        # self.model_dqn.compile(optimizer=sgd, loss='mse')
    ...
    def make_dqn(self):
        ...
        conv1 = Conv2D(64, 5, strides=1)(frames_input)
    ...
    def fit_batch(self, start_states, ally_actions, actions, rewards, next_states):
        ...
        # print feedback every 1000 iterations
